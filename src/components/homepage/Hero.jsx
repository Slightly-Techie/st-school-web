        ...
        <section className="max-w-screen-xl mx-auto h-full p-5 xl:px-0 flex flex-col justify-center">
          ...
          <section className="w-full flex flex-col md:flex-row gap-5 mb-8">
            <section className="md:w-[50%]">
              <h1 className="text-3xl lg:text-5xl font-bold leading-8">
                Unlocking Your Path to Continuous Learning and Boundless
                Personal Growth
              </h1>
            </section>
            <section className="md:w-1/2">
              <p className="hidden md:block">
                Discover a world of knowledge and endless possibilities. Join
                thousands of learners who are enhancing their skills, advancing
                their careers, and pursuing their passions with our
                comprehensive learning platform.
              </p>
              <p className="block md:hidden">
                Explore endless knowledge and opportunity. Join thousands in
                advancing their skills and passions with us.
              </p>
              <br />
          ...
          <section className="w-full mb-8">
            <img
              ...
              alt="hero-img"
              className="rounded-3xl md:h-[300px] lg:h-[350px] xl:h-[350px] w-full object-cover"
            />
          </section>
          {/* Bottom */}
