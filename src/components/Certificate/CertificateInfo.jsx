...
const CertificateInfo = () => {
  return (
    <>
      <div className="container border-[50px] py-4 border-[#434343] overflow-x-hidden">
        <div className="flex flex-col items-center justify-center pt-5">
          ...
          <h1 className="text-4xl font-extrabold mt-1 text-[#434343]">
            CERTIFICATE OF COURSE COMPLETION
          </h1>
          <h3 className="text-xl pt-1 pb-2">Awarded To</h3>
          <h1 className="text-3xl font-bold mt-2 text-[#434343]">
            PROF. NANA KWESI ASANTE
          </h1>
          <h3 className="text-xl pt-1 pb-2">having successfully completed</h3>
          <h1 className="text-2xl font-bold mt-4 text-[#434343]">
